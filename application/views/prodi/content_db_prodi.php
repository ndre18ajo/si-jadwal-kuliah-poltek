    <section class="content">
        <div class="container-fluid">
                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                                            ...
                                            <?php endif; ?>
                          <form action="<?php echo base_url('c_prodi/tambah');?>" method="post" role="form">
                                ...
                                <div class="row">
                                    <div class="col-md-9">
                                        <div class="alert bg-teal alert-dismissible">
                                            Data Program Studi <strong>berhasil</strong> <?php echo $this->session->flashdata('flash'); ?>
                                    ...
                                    <tbody>
                                      <?php $no=1; foreach($all as $row): ?>
                                        <tr>
                                            ...
                                            <td>
                                              <center>
                                                <a data-toggle="modal" data-target="#modal-edit1<?=$row->id_prodi;?>" class="btn btn-warning btn-circle" data-popup="tooltip" data-placement="top" title="Edit Data"><i class="material-icons">update</i></a>

                                                    <a data-toggle="modal" data-target="#modal-hapus<?=$row->id_prodi;?>" class="btn btn-danger btn-circle" data-popup="tooltip" data-placement="top" title="Hapus Data"><i class="material-icons">delete</i></a>
                                              </center>
                                            </td>
                                        </tr>
                                        <?php endforeach; ?>
            ...
            <div class="row">
              <div id="modal-hapus<?=$row->id_prodi;?>" class="modal fade">
                <div class="modal-dialog">
                  <form action="<?php echo site_url('c_prodi/hapus'); ?>" method="post">
                  <div class="modal-content">
                    <div class="modal-header bg-primary">
                    ...
                    <div class="modal-body">
                      ...
                      <input type="hidden" readonly value="<?php echo $row->id_prodi; ?>" name="id_prodi" class="form-control" >
            ...
            <?php $no=0; foreach($all as $row):  ?>
            <div class="row">
              <div id="modal-edit1<?=$row->id_prodi;?>" class="modal fade">
                <div class="modal-dialog">
                  <form action="<?php echo site_url('c_prodi/edit'); ?>" method="post">
                  <div class="modal-content">
                    <div class="modal-header bg-primary">
